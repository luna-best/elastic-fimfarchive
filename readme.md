...
2. Run `python folders.py --folder-path /path/to/extracted/archive` and it should create the file `folders.sqlite` in its working directory.
3. Edit `index-fics.ini` and point `folders-db` at the SQLite database.
